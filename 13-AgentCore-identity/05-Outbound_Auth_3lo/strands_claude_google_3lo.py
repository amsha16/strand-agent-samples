...
@requires_access_token(
    ...
    callback_url="https://2tsypbyep8wxkc3.studio.us-west-2.sagemaker.aws/jupyterlab/default/proxy/9090/oauth2/callback"  # ← Callback URL determined from notebook environment
)
